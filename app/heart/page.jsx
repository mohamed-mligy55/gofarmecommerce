...
const WishlistPage = () => {
    ...
    const addToCart = (product) => {
        ...
        // يمكنك إضافة alert أو toast هنا للتأكيد
    }
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex flex-col gap-3 mt-4">
                                    ...
                                    <div className="flex items-center justify-between border border-gray-200 rounded-full px-2 py-1 bg-white">
                                        <button className="w-8 h-8 flex items-center justify-center hover:bg-gray-100 rounded-full text-gray-500">-</button>
                                        <span className="font-semibold text-sm text-gray-700">1</span>
                                        <button className="w-8 h-8 flex items-center justify-center hover:bg-gray-100 rounded-full text-gray-500">+</button>
                                    </div>
                                    ...
                                    <button 
                                        ...
                                        className="w-full bg-[#00B207] hover:bg-[#008A05] text-white font-bold py-3 rounded-full flex items-center justify-center gap-2 transition-colors shadow-sm active:scale-95"
                                    >
